...
3. **Respect the envelope.** Floors: **G3 >= 20 fps, G4/Lion/G5/modern >= 25 fps**.
   A feature that keeps its class at or above the floor stays on; win extra fps
   by **optimising code, not by switching features off**.
