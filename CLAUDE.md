...
## Goal in one line
Best-looking ioquake3 that stays playable on each machine class, from one fat binary that auto-tunes per machine. Floors: **G3 >= 20 fps, G4/Lion/G5/modern >= 35 fps**. **Above the floor, effects beat fps.**
